...
- [`bpe-from-scratch-simple.ipynb`](bpe-from-scratch-simple.ipynb) explains and shows how the BPE tokenizer works under the hood; this is geared for simplicity and readability.
